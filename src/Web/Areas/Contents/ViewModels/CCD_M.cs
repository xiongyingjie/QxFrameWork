...
namespace Web.Areas.Contents.ViewModels
{
    public class CCD_M
    {
        public ContentColumnDesign ToModel()
        {
            return new ContentColumnDesign()
            {
                Seq = Seq,
                PCT_ID = PCT_ID,
                IsPk = IsPk,
        ...
        public static CCD_M ToViewModel(List<SelectListItem> CTDselectItems, List<SelectListItem> DTelectItems, List<SelectListItem> PCTselectItems)
        {
            return new CCD_M()
            {
        ...
        public static CCD_M ToViewModel(ContentColumnDesign contentColumnDesign,List<SelectListItem> CTDselectItems, List<SelectListItem> DTelectItems, List<SelectListItem> PCTselectItems)
        {
            return new CCD_M()
            {

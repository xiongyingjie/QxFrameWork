...
namespace Web.Areas.Contents.ViewModels
{
    public class CTQ_M
    {
        public ContentTableQuery ToModel()
        {
            return new ContentTableQuery() { CTD_ID=CTD_ID, CTQ_ID=CTQ_ID, SqlQuery=SqlQuery};
        }
        public static CTQ_M ToViewModel(List<SelectListItem> CTDselectItems)
        {
            return new CTQ_M() {CTDselectItems = CTDselectItems };
        }
        public static CTQ_M ToViewModel(ContentTableQuery contentTableQuery, List<SelectListItem> CTDselectItems)
        {

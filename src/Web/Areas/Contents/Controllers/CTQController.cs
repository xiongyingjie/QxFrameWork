...
namespace Web.Areas.Contents.Controllers
{
    public class CTQController : BaseContentsController, ICrud<CTQ_M>
    {
        ...
        private IRepository<ContentTableQuery> _repository;
        private IRepository<ContentTableDesign> _ctdrepository;
        public CTQController(IRepository<ContentTableQuery> repository, IRepository<ContentTableDesign> ctdrepository)
        {
